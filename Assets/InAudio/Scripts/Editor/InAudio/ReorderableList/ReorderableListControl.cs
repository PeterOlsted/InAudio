...
namespace InAudioSystem.ReorderableList
{
	...
	public class ReorderableListControl {
		...
		private void PrepareState(int controlID, IReorderableListAdaptor adaptor) {
            ...
            _visibleRect = InAudioSystem.ReorderableList.Internal.GUIHelper.VisibleRect();
		...
		private void DrawListItem(EventType eventType, Rect position, IReorderableListAdaptor adaptor, int itemIndex) {
			...
			if (eventType == EventType.Repaint && visible) {
				...
				if (draggable) {
                    ...
                    InAudioSystem.ReorderableList.Internal.GUIHelper.DrawTexture(texturePosition, ReorderableListResources.texGrabHandle);
				}
				...
				if (!_tracking || itemIndex != s_AnchorIndex) {
                    ...
                    InAudioSystem.ReorderableList.Internal.GUIHelper.DrawTexture(texturePosition, ReorderableListResources.texItemSplitter);
				}
			}
		...
		private void DrawFloatingListItem(EventType eventType, IReorderableListAdaptor adaptor, float targetSlotPosition) {
			if (eventType == EventType.Repaint) {
                ...
                InAudioSystem.ReorderableList.Internal.GUIHelper.DrawTexture(targetPosition, ReorderableListResources.texItemSplitter);
                ...
                InAudioSystem.ReorderableList.Internal.GUIHelper.DrawTexture(targetPosition, EditorGUIUtility.whiteTexture);
                ...
                InAudioSystem.ReorderableList.Internal.GUIHelper.DrawTexture(s_DragItemPosition, EditorGUIUtility.whiteTexture);
...
//*/
		...
		private void CheckForAutoFocusControl(int controlID) {
			...
			if (s_AutoFocusControlID == controlID) {
                ...
                InAudioSystem.ReorderableList.Internal.GUIHelper.FocusTextInControl("AutoFocus_" + controlID + "_" + s_AutoFocusIndex);
				s_AutoFocusIndex = -1;
			}
		}
